...
def get_policy_kl(policy, observation, noised_obs): 
    out = policy.forward(observation)
    policy_mean, policy_std = out.mean, out.stddev
    noised_out = policy.forward(noised_obs)
    noised_policy_mean, noised_policy_std = noised_out.mean, noised_out.stddev
